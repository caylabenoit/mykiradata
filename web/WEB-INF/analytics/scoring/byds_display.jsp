            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 class="page-header"><joy:ActionValueTag name="DSO_SOURCENAME" /></h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading"><UI:dgmGlyphe name="datasource" />Data Source: <joy:ActionValueTag name="DSO_SOURCENAME" /></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <Label>Definition : </Label>
                                <joy:ActionValueTag name="DSO_SOURCENAME" />
...
$(document).ready(function() {
    ...
    $( '#ds' ).select2({
        placeholder: "Select an DataSource"
    });
    $( "#btn1" ).button();
