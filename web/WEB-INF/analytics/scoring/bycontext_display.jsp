...
<body>
    <div id="wrapper">
        ...
        <nav class="navdgm navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <joy:NaviLeftMenuTag xmlconfig="joy-menu.xml" activemenuid="Analytics-S-Context"  />
        </nav>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <joy:NaviBreadCrumbsTag xmlconfig="joy-menu.xml" activemenuid="Analytics-S-Context" />
                        <h1 class="page-header"><joy:ActionValueTag name="CON_DESCRIPTION" /></h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading"><UI:dgmGlyphe name="context" />Context: <joy:ActionValueTag name="CON_DESCRIPTION" /></div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <Label>Definition : </Label>
                                <joy:ActionValueTag name="CON_DESCRIPTION" />
                                <joy:JoyFormTag inline="true" object='bycontext' actiontype='display' name='myform'>
                                <div class="form-group">
                                    <joy:ActionComboBoxTag name="context" CSSClass="js-states form-control" />
