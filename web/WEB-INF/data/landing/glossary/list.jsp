                ...
                <div class="row">
                    ...
                    <div class="col-lg-10">
                        <div class="panel panel-default">
                            <div class="panel-heading"><UI:dgmGlyphe name="term"/>Business Glossary Landing data</div>
                            <!-- /.panel-heading -->
                            <div class="panel-body">
                                <div class="dataTable_wrapper"> 
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-circle" onclick="Delete('<joy:JoyBasicURL object="lndglossary" actiontype="delete" />&JOYFUNCKEY=<joy:ActionMatrixByRowTag name="JOYFUNCKEY" />');"><i class="fa fa-times"></i></button>
                                                </td>
                                            </tr>
                                    ...
                                    <joy:JoyFormTag object='lndglossary' actiontype='add' name='frmEditItem' >  
                                    <joy:JoyHiddenTag name="NEW" value="yes" />
                                    <p><joy:JoyFormButtonTag id="btn1" label="<i class='fa fa-plus-circle'></i>&nbsp;Add new Glossary" CSSClass="btn btn-success" onclick="document.forms['frmEditItem'].submit();" />
                                    </joy:JoyFormTag>
